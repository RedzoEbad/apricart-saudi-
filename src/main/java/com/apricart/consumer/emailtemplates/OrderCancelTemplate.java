...
public class OrderCancelTemplate implements EmailTemplate {
    protected static final Logger LOGGER = LoggerFactory.getLogger(OrderCancelTemplate.class);
    ...
    public OrderCancelTemplate(Orders order, String imageURL) throws IOException {
        ...
        this.message = "<!DOCTYPE html>\n" +
                ...
                "                                                                                                                            <div>\n" +
                "                                                                                                                                <div style=\"font-family: inherit; text-align: inherit\"><span style=\"font-size: 16px\">We're sorry to inform you that your order #"+orderNumber+" has been canceled as requested.</span></div><div></div>\n" +
                "                                                                                                                               <div style=\"font-family: inherit; text-align: inherit\"><span style=\"font-size: 16px\">Here are the details of the canceled order:</span></div><div></div>\n" +
                ...
                "                                                                                                                        <td style=\"padding: 12px 18px 4px 0px; line-height: 24px; text-align: inherit;\" height=\"100%\" valign=\"top\" bgcolor=\"\" role=\"module-content\">\n" +
                "                                                                                                                            <div>\n" +
                "                                                                                                                                <div style=\"font-family: inherit; text-align: inherit\"><span style=\"font-size: 16px\">If you have any questions or need further assistance, please contact our customer support at hello@apricart.ai.</span></div><div></div>\n" +
                "                                                                                                                            </div>\n" +
                "                                                                                                                        </td>\n" +
                "                                                                                                                    </tr>\n" +
                "\n" +
                ...
                "                                                                                                                        <td style=\"padding: 12px 18px 4px 0px; line-height: 24px; text-align: inherit;\" height=\"100%\" valign=\"top\" bgcolor=\"\" role=\"module-content\">\n" +
                "                                                                                                                            <div>\n" +
                "                                                                                                                                <div style=\"font-family: inherit; text-align: inherit\"><span style=\"font-size: 16px\">We apologize for any inconvenience this may have caused.</span></div><div></div>\n" +
                "                                                                                                                            </div>\n" +
                "                                                                                                                        </td>\n" +
                "                                                                                                                    </tr>\n" +
                "                                                                                                                </tbody>\n" +
