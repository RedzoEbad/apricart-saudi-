...
public class SettingController {
    ...
    public ResponseEntity<GenericResponse<List<SettingResponseDTO>>> findSettingByWarehouseId(@PathVariable Long id,
            @RequestHeader("Language") LanguageType lang) {
    ...
    @PostMapping
    public ResponseEntity<GenericResponse<SettingResponseDTO>> addSetting(
            @Valid @RequestBody SettingRequestDTO settingRequestDTO, @RequestHeader("Language") LanguageType lang) {
    ...
    @PutMapping
    public ResponseEntity<GenericResponse<SettingResponseDTO>> updateSetting(
            @Valid @RequestBody SettingRequestDTO settingRequestDTO, @RequestHeader("Language") LanguageType lang) {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<GenericResponse<String>> deleteSetting(@PathVariable Long id,
            @RequestHeader("Language") LanguageType lang) {
        settingService.deleteSetting(id, lang);
        return lang.equals(LanguageType.ARB) ? Response.success(SETTINGS_REMOVED_SUCCESSFULLY_ARABIC)
                : Response.success(SETTINGS_REMOVED_SUCCESSFULLY);
    }
}